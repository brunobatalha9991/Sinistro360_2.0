...
import {
  ...
  MOCK_OVERRIDES, MOCK_CONFIG, MOCK_RESPONSABILIDADE_HISTORICO, MOCK_AI_AUDITORIA,
  MOCK_AI_MEMORIAS, MOCK_AI_FEEDBACK,
  MOCK_OFICINAS, MOCK_OFICINA_OCORRENCIAS, MOCK_OFICINA_COMUNICACOES,
  MOCK_SEGURADORAS, MOCK_SEGURADORA_OCORRENCIAS, MOCK_SEGURADORA_COMUNICACOES,
  MOCK_CLIENTES, MOCK_CLIENTE_OCORRENCIAS, MOCK_CLIENTE_COMUNICACOES,
} from "./mockData";
...
const RECORD_SEED = {
  ...
  corp_ai_auditoria: MOCK_AI_AUDITORIA,
  corp_ai_memorias: MOCK_AI_MEMORIAS,
  corp_ai_feedback: MOCK_AI_FEEDBACK,
  corp_oficinas: MOCK_OFICINAS,
  corp_oficina_ocorrencias: MOCK_OFICINA_OCORRENCIAS,
  corp_oficina_comunicacoes: MOCK_OFICINA_COMUNICACOES,
  corp_seguradoras: MOCK_SEGURADORAS,
  corp_seguradora_ocorrencias: MOCK_SEGURADORA_OCORRENCIAS,
  corp_seguradora_comunicacoes: MOCK_SEGURADORA_COMUNICACOES,
