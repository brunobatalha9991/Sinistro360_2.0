...
export function PesquisaSatisfacaoPanel({ c, overrides, actions, canEdit, atendTemplateCfg, templates }) {
  ...
  const finalizado = isFinalizado(overrides, c, atendTemplateCfg, templates);
