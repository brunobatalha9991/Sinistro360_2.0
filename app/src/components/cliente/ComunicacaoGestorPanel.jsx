...
// Comunicação do gestor com o cliente (a pedido do usuário) — registro
// independente do histórico de cada sinistro, pensado como evidência pra
// alinhar em reuniões com o cliente.
export function ComunicacaoGestorPanel({ clienteId, actions, canEdit }) {
  ...
  function registrar() {
    ...
    actions.addComunicacaoGestor(clienteId, { tipo, data, resumo });
    setResumo("");
  }

  return (
    <div className="card">
      <h3 style={{ marginTop: 0 }}>Registrar comunicação com o cliente</h3>
