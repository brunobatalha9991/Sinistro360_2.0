...
export const CATALOGO_DASHBOARDS = {
  dashboard: {
    ...
    indicadores: [
      ...
      { chave: "por_situacao", label: "Em andamento / Indenizados / Constatação / Sem indenização / Pendentes / Negados", formula: "contagem por situacaoEfetiva(overrides, c).label", fonte: "corp_claims + corp_overrides" },
      { chave: "taxa_indenizacao", label: "Taxa de indenização", formula: "indenizados / total * 100", fonte: "calculado sobre o recorte" },
      { chave: "constatacoes", label: "Constatações", formula: "contagem de situacaoEfetiva == 'Constatação' — atendimento aberto só pra cobertura ao terceiro, sem indenização ao segurado", fonte: "corp_claims + corp_overrides" },
      { chave: "taxa_desfecho_positivo", label: "Taxa de desfecho positivo", formula: "(indenizados + constatações) / total * 100", fonte: "calculado sobre o recorte", limitacoes: "Constatação não entra nos valores financeiros (Total indenizado/ticket médio), só nesta taxa combinada" },
