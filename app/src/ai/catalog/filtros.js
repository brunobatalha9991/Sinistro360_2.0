...
export const CATALOGO_FILTROS = {
  sinistros: {
    ...
    filtros: [
      ...
      { campo: "status", label: "Situação do processo", tipo: "chip único", opcoes: "Todos, Em andamento, Pendente, Indenizado, Sem indenização", detalhe: "usa a situação EFETIVA (jornada do usuário), não o campo bruto da API CORP" },
